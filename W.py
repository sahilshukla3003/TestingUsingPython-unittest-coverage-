...
def tell_weather():
    api_key = "44778972071a5dcc355866aff1176601"
...
if __name__ == "__main__":
    ...
    label1 = Label(root, text="City name : ", fg='black', bg='green')
    label2 = Label(root, text="Temperature :", fg='black', bg='green')
    label3 = Label(root, text="atm pressure :", fg='black', bg='green')
    label4 = Label(root, text="humidity :", fg='black', bg='green')
    label5 = Label(root, text="description :", fg='black', bg='green')
